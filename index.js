...
const dbURL = "mongodb+srv://zawa7f:ss4ot72kLwqJxEO0@cluster0.xhukn.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
let ownertr = "982625141605429298"
let probotId = "282859044593598464"

let owners = ["982625141605429298"]
...
client.probot = Probot(client, {
  ...
  data: [
    {
      fetchMembers: true,
      guildId: "1187414152474533908",
      probotId: "282859044593598464",
      owners: ["982625141605429298"],
...
client.on("messageCreate", async (message) => {
  ...
  const parentId = "1187414152474533909";
...
client.login('MTI5OTQzOTYwNjU1NDY4OTY1OA.GVzaR2.LUrvedJTMSpUM0PwTLVkpBRYyEuQ4t7BiXcPIQ')